...
static void parse_options(gameport* instance, const char* options);
static void verb(gameport* instance, const char* fmt, ...);
...
gameport* gameport_create(unsigned int viewport_width, unsigned int viewport_height, const char* options) {
    ...
    gameport* instance = (gameport*) malloc(sizeof(struct gameport_struct));    
...
static void parse_options(gameport* instance, const char* options) {
    verb(instance, "parse_options called\n");
}
